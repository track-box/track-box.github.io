...
function TrackboxTrack(url, div_id, options) {
	this._url = url;
	this._host = "https://track-box.github.io";
	this._api = "https://trackbox-154715.appspot.com";
	this._storage = "https://storage.googleapis.com/trackbox/";
	...
	if (url == ""){
		...
		if (options && options.edit){
			this._edit_id = id;
			url = this._storage + "edit/" + id;

		}else{
			url = this._storage + "track/" + id;
		}
	}
	console.log(url);
	var self = this;
